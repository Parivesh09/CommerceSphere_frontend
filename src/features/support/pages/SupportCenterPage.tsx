    ...
    <div className="page-bg pt-28 pb-16">
      <main className="max-w-4xl mx-auto px-6 space-y-12">
        <div className="text-center space-y-3">
          <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100">Enterprise Support Center</h1>
        ...
        <div className="surface-card rounded-3xl p-8 space-y-6">
          <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100 pb-3 border-b border-slate-200">Submit Priority Ticket</h2>
